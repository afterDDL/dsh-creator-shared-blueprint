...
| `ctx.blueprintAdapter` | `core` | [`blueprint-adapter`](../packages/bundle/shared-blueprint) | - | - | - | Projects preset composition, runtime assembly, and access state; writes only Purpose, numbered Behavior, and Web Fetch for user-authored presets. |
