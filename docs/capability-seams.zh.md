...
| `ctx.blueprintAdapter` | `core` | [`blueprint-adapter`](../packages/bundle/shared-blueprint) | - | - | - | 投影 preset composition、runtime 组装与 access 状态；对于用户创作的 preset，只写入 Purpose、带编号的 Behavior 与 Web Fetch。 |
