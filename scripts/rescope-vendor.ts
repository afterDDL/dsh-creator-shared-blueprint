...
const GENERIC_SKIPS: readonly GenericSkip[] = [
  ...
  // Cordis Remote event names, Client extension ids, and the catalogs generated
  // from them are product protocol identifiers, not package specifiers.
  ...
  { file: 'packages/client/connection/src/client/fixture.ts', upstream: ['cordis'] },
  { file: 'packages/client/connection/tests/fixture.client.spec.ts', upstream: ['cordis'] },
  { file: 'packages/client/ui-conversation/src/client/skeleton/ConversationRoot.tsx', upstream: ['cordis'] },
  { file: 'packages/client/ui-conversation/tests/skeleton.client.spec.tsx', upstream: ['cordis'] },
