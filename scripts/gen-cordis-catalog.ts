...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  BlueprintApplyChangeSetResult: 'transaction result is owned by packages/bundle/shared-blueprint/README.md',
  BlueprintApplyChangeSetStatus: 'transaction status is owned by packages/bundle/shared-blueprint/README.md',
  BlueprintCancelChangeSetRequest: 'transaction input is owned by packages/bundle/shared-blueprint/README.md',
  BlueprintChangeReceipt: 'runtime receipt is owned by packages/bundle/shared-blueprint/README.md',
  BlueprintConformanceStatus: 'runtime status is owned by packages/bundle/shared-blueprint/README.md',
  BlueprintPromptEvidence: 'runtime prompt evidence is owned by packages/bundle/shared-blueprint/README.md',
  BlueprintSessionBindingEvidence: 'runtime binding evidence is owned by packages/bundle/shared-blueprint/README.md',
  BlueprintRuntimeDelegation: 'runtime delegation projection is owned by packages/bundle/shared-blueprint/README.md',
  BlueprintRuntimeSkill: 'runtime Skill projection is owned by packages/bundle/shared-blueprint/README.md',
  BlueprintSkillEvidence: 'runtime Skill evidence is owned by packages/bundle/shared-blueprint/README.md',
  BlueprintDelegationEvidence: 'runtime delegation evidence is owned by packages/bundle/shared-blueprint/README.md',
  BlueprintToolEvidence: 'runtime Tool evidence is owned by packages/bundle/shared-blueprint/README.md',
  BlueprintReadOptions: 'service input is owned by packages/bundle/shared-blueprint/README.md',
  BlueprintIdentityWrite: 'service input is owned by packages/bundle/shared-blueprint/README.md',
  BlueprintImpactCandidate: 'reconciliation candidate is owned by packages/bundle/shared-blueprint/README.md',
  BlueprintImpactEvidence: 'reconciliation evidence is owned by packages/bundle/shared-blueprint/README.md',
  BlueprintTextWrite: 'service input is owned by packages/bundle/shared-blueprint/README.md',
  BlueprintBehaviorWrite: 'service input is owned by packages/bundle/shared-blueprint/README.md',
  BlueprintCapabilityWrite: 'service input is owned by packages/bundle/shared-blueprint/README.md',
  BlueprintChangeSetCapabilityOperation: 'transaction operation is owned by packages/bundle/shared-blueprint/README.md',
  BlueprintChangeSetOperation: 'transaction operation is owned by packages/bundle/shared-blueprint/README.md',
  BlueprintChangeSetTextOperation: 'transaction operation is owned by packages/bundle/shared-blueprint/README.md',
  BlueprintConversationContextRequest: 'service input is owned by packages/bundle/shared-blueprint/README.md',
  BlueprintConversationContextResult: 'service result is owned by packages/bundle/shared-blueprint/README.md',
  BlueprintGetRequest: 'service input is owned by packages/bundle/shared-blueprint/README.md',
  BlueprintOutputWrite: 'service input is owned by packages/bundle/shared-blueprint/README.md',
  BlueprintProposalCancellation: 'transaction result is owned by packages/bundle/shared-blueprint/README.md',
  BlueprintSessionValidation: 'service result is owned by packages/bundle/shared-blueprint/README.md',
  BlueprintValidateSessionRequest: 'service input is owned by packages/bundle/shared-blueprint/README.md',
