...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  Blueprint: 'projection result is owned by packages/preset/blueprint-adapter/README.md',
  BlueprintApplyChangeSetRequest: 'transaction input is owned by packages/preset/blueprint-adapter/README.md',
  BlueprintApplyChangeSetResult: 'transaction result is owned by packages/preset/blueprint-adapter/README.md',
  BlueprintApplyChangeSetStatus: 'transaction status is owned by packages/preset/blueprint-adapter/README.md',
  BlueprintCancelChangeSetRequest: 'transaction input is owned by packages/preset/blueprint-adapter/README.md',
  BlueprintChangeReceipt: 'runtime receipt is owned by packages/preset/blueprint-adapter/README.md',
  BlueprintConformanceStatus: 'runtime status is owned by packages/preset/blueprint-adapter/README.md',
  BlueprintPromptEvidence: 'runtime prompt evidence is owned by packages/preset/blueprint-adapter/README.md',
  BlueprintSessionBindingEvidence: 'runtime binding evidence is owned by packages/preset/blueprint-adapter/README.md',
  BlueprintRuntimeDelegation: 'runtime delegation projection is owned by packages/preset/blueprint-adapter/README.md',
  BlueprintRuntimeSkill: 'runtime Skill projection is owned by packages/preset/blueprint-adapter/README.md',
  BlueprintSkillEvidence: 'runtime Skill evidence is owned by packages/preset/blueprint-adapter/README.md',
  BlueprintDelegationEvidence: 'runtime delegation evidence is owned by packages/preset/blueprint-adapter/README.md',
  BlueprintToolEvidence: 'runtime Tool evidence is owned by packages/preset/blueprint-adapter/README.md',
  BlueprintReadOptions: 'service input is owned by packages/preset/blueprint-adapter/README.md',
  BlueprintIdentityWrite: 'service input is owned by packages/preset/blueprint-adapter/README.md',
  BlueprintImpactCandidate: 'reconciliation candidate is owned by packages/preset/blueprint-adapter/README.md',
  BlueprintImpactEvidence: 'reconciliation evidence is owned by packages/preset/blueprint-adapter/README.md',
  BlueprintTextWrite: 'service input is owned by packages/preset/blueprint-adapter/README.md',
  BlueprintBehaviorWrite: 'service input is owned by packages/preset/blueprint-adapter/README.md',
  BlueprintCapabilityWrite: 'service input is owned by packages/preset/blueprint-adapter/README.md',
  BlueprintChangeSetCapabilityOperation: 'transaction operation is owned by packages/preset/blueprint-adapter/README.md',
  BlueprintChangeSetOperation: 'transaction operation is owned by packages/preset/blueprint-adapter/README.md',
  BlueprintChangeSetTextOperation: 'transaction operation is owned by packages/preset/blueprint-adapter/README.md',
  BlueprintConversationContextRequest: 'service input is owned by packages/preset/blueprint-adapter/README.md',
  BlueprintConversationContextResult: 'service result is owned by packages/preset/blueprint-adapter/README.md',
  BlueprintGetRequest: 'service input is owned by packages/preset/blueprint-adapter/README.md',
  BlueprintOutputWrite: 'service input is owned by packages/preset/blueprint-adapter/README.md',
  BlueprintProposalCancellation: 'transaction result is owned by packages/preset/blueprint-adapter/README.md',
  BlueprintSessionValidation: 'service result is owned by packages/preset/blueprint-adapter/README.md',
  BlueprintValidateSessionRequest: 'service input is owned by packages/preset/blueprint-adapter/README.md',
