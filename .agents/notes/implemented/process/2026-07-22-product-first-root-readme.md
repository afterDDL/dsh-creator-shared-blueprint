...
This decision owns the upstream DSH product repository. A distribution fork whose root releases another product follows its own product-entry decision; Shared Blueprint uses [Interactive Preview release distribution](2026-09-01-interactive-preview-release-distribution.md).
