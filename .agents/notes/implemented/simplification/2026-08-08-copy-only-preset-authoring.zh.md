...
- [Interactive Blueprint adapter](../feature/2026-08-24-interactive-blueprint-preset-adapter.md) 为 user preset 增加类型化语义 Host API。它没有把 composition 文本、路径或任意 YAML 写入恢复到浏览器 authoring API，因此本决策继续拥有该 wire 限制。
