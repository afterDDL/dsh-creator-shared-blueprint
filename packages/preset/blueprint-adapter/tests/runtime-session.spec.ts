...
import * as Persona from '../../persona/src/index.ts'
...
): NonNullable<import('../src/types.ts').BlueprintConversationContextRequest['capabilityAuthoring']> {
...
`)
  ...
  it('admits capability continuation only from exact durable source authority into one clean cordis child', async () => {
    ...
    const expectNoAdoption = async (
      agent: import('@deepseek-ai/dsh-agent').Agent,
      request: NonNullable<import('../src/types.ts').BlueprintConversationContextRequest['capabilityAuthoring']>,
    ) => {
