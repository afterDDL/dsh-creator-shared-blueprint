...
import { projectBehaviors } from '../src/behavior.ts'
import { parseComposition, personaText, projectPersona } from '../src/composition.ts'
import { applyBlueprintOperation, isOutputItem } from '../src/writeback.ts'
