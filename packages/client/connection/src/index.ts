...
const PRIVILEGED_METHODS = new Set([
  ...
  'blueprint/updateIdentity',
  'blueprint/updatePurpose',
  'blueprint/updateBehavior',
  'blueprint/setCapability',
  'blueprint/setConversationContext',
  'blueprint/updateOutput',
  'blueprint/validateSession',
  'host.pickDirectory',
  'host.openPath',
  'settings.describe',
