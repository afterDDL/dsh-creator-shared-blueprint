...
export function creatorAuthoringGuidance(
  draft: NonNullable<import('../contract/types.ts').BlueprintConversationContextRequest['creatorDraft']>,
  selectedNode?: import('../contract/types.ts').BlueprintNode,
...
export function capabilityAuthoringGuidance(
  context: NonNullable<import('../contract/types.ts').BlueprintConversationContextRequest['capabilityAuthoring']>,
): string {
