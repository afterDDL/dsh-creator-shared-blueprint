...
} from '../src/host/capability-candidate.ts'
import { assertCapabilityCompositionDelta, compositionRevision } from '../src/host/composition.ts'
import type { BlueprintCapabilityCandidate } from '../src/contract/types.ts'
